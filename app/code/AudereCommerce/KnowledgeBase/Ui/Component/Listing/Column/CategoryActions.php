...
namespace AudereCommerce\KnowledgeBase\Ui\Component\Listing\Column;
...
class CategoryActions extends Column
{
    ...
    const PATH_DELETE = 'knowledgebase/category/delete';

    const PATH_EDIT = 'knowledgebase/category/edit';
